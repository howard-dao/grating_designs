...
%   sin_to_sin_space
%	type: doube, scalar
%	desc: spacing between the first and second nitride layers [nm]
%   top_nitride_thick
%       type: double, scalar
...
switch geometry
    ...
    case 'custom'
        ...
        si_to_bot_sin       = 100;
        bot_sin_thick       = 220;
        sin_to_sin_thick    = sin_to_sin_space;
...
switch geometry
    case 'default'
        save_data_path = [  pwd filesep ...
                            ...
                            '_angle' num2str(optimal_angle) ...
                            '_dx_' num2str(synth_obj.discretization) ...
                            '_' coupling_direction ];
    case 'custom'
        save_data_path = [  pwd filesep ...
			    'nitride_space' num2str(sin_to_sin_space) ...
                            '_top_nitride' num2str(top_nitride_thick) ...
                            '_lam' num2str(lambda) ...
                            '_angle' num2str(optimal_angle) ...
                            '_dx_' num2str(synth_obj.discretization) ...
                            '_' coupling_direction ];
